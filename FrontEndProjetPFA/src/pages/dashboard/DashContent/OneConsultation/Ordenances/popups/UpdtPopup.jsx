...
import { UpdateOrd } from "../../../../../../redux/Ordenances/Ordenances.actions";
...
const AddPopup = (props) => {
  ...
  const handle_Submit = () => {
    dispatch(UpdateOrd(form, handleClose));
  };
    ...
    <Popup handleClose={handleClose} width="900px">
      <div className={classes.main}>
        ...
        <div className="buttons_group">
          ...
          <Button onClick={handle_Submit}>Modifier Ordennance</Button>
        </div>
      </div>
    </Popup>
  );
