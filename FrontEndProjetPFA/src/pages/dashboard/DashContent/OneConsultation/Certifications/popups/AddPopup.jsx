...
import { CreateCert } from "../../../../../../redux/Certifs/Certifs.actions";
...
const AddPopup = (props) => {
  ...
  const handle_Submit = () => {
    dispatch(CreateCert(form, handleClose));
  };
    ...
    <Popup handleClose={handleClose} width="900px">
      <div className={classes.main}>
          ...
          <>
            ...
            <Grid item xs={6}>
              ...
              <Input
                ...
                placeholder="Entrer nombre des jours de dispense"
              />
            </Grid>
          </>
        ...
        <div className="buttons_group">
          ...
          <Button onClick={handle_Submit}>Ajouter Certificat</Button>
        </div>
      </div>
    </Popup>
  );
