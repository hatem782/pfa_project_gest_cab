...
import { CreateAnteced } from "../../../../../../redux/Antecedents/Antecedents.actions";
...
const AddPopup = (props) => {
  ...
  const handle_Submit = () => {
    dispatch(CreateAnteced(form, handleClose));
  };
    ...
    <Popup handleClose={handleClose} width="900px">
      <div className={classes.main}>
        <div className="between">
          <h3>Ajouter Un Nouveau Antecedent</h3>
        </div>
        ...
        <div className="buttons_group">
          ...
          <Button onClick={handle_Submit}>Ajouter Antecedent</Button>
        </div>
      </div>
    </Popup>
  );
